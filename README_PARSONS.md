...
New files added:
- `app/omr/parsons_processor.py` - Parsons processing and scoring logic
- Backend: Updated `templateConstants.js` and `templateGenerator.js`
- Frontend: Updated `CustomBubbleSheet.js` component

## Testing

Use the `/score_parsons` endpoint to test scoring algorithms with different sequences before deploying to production.